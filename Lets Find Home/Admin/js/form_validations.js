...
function form_validate(){
    ...
    if(y==""){
        ...
        if(isNaN(y)==true){
            ...
            document.getElementById("nidError").innerHTML="NID can consist of 10 digits only";
            nidErr="Error";
        }
        else{
            nidErr="";
    ...
    if(pass==""){
        document.getElementById("passError").innerHTML="Password Field Cannot be Empty";
        passErr="Error";
    }
    else{
        if((/[a-z]+/.test(pass))==false){
        document.getElementById("passError").innerHTML="Your Password should contain at least one small letter";
        passErr="Error";
        }
        else if((/[\'^£$%&*()}{@#~?><>,|=_+¬-]/.test(pass))==false){
        document.getElementById("passError").innerHTML="Your Password should contain at least one special character";
        passErr="Error";
        }
        else if((/[0-9]+/.test(pass))==false){
            document.getElementById("passError").innerHTML="Your Password should contain at least one number";
            passErr="Error";
        }
        else if(pass.length<8){
            document.getElementById("passError").innerHTML="Your Password should contain at least 8 characters";
            passErr="Error";
        }
        else{
            passErr="";
    ...
    if(pass2==""){
        document.getElementById("cpassError").innerHTML="Confirm Password Field Cannot be Empty";
        cpassErr="Error";
    }
    else{
        if(pass2!=pass){
    ...
    if(document.getElementById("m").checked==false && document.getElementById("f").checked==false && document.getElementById("p").checked==false){
        document.getElementById("genderError").innerHTML="Gender Field cannot be empty";
        genderErr="Error";
    }
    else{
        genderErr="";
    ...
    if(nameErr!="" || nidErr!="" ||passErr!="" || cpassErr!="" || genderErr!="" || emailErr!=""){
        return false;
    }else if(nameErr=="" && nidErr=="" && passErr=="" && cpassErr=="" && genderErr=="" && emailErr==""){
        return true;
    }
}
...
function login_validation(){
    ...
    if(y==""){
        ...
        document.getElementById("pass_Error").innerHTML="Password Field Cannot be Empty";
        pass_Error="Error";
    }
    else{
        pass_Error="";
...
function pass_validate(){
 ...
 function give_notice_validation(){
    ...
    if(notice_id==""){
        ad_idError="Error";
        document.getElementById("noticeIDErr").innerHTML="Notice ID cannot be empty.";
    }
    else{
        ad_idError="";
    ...
    if(renter_id==""){
        r_idError="Error";
        document.getElementById("renterIDErr").innerHTML="Renter ID cannot be empty";
    }
    else{
        if(isNaN(renter_id)==true){
            r_idError="Error";
            document.getElementById("renterIDErr").innerHTML="Renter ID can only be numbers";
        }
        else{
            r_idError="";
 ...
 function edit_profile_validate(){
    ...
    if(nameErr!="" || passErr!="" || cpassErr!="" || emailErr!=""){
        return false;
    }else if(nameErr=="" && passErr=="" && cpassErr=="" && emailErr==""){
        return true;
    }
 }
 ...
 function dp_validate(){
   ...
   var valid_ext=["jpeg","jpg","png"];
    ...
    if(img.value==""){
        ...
        document.getElementById("ImageError").innerHTML="Please Select an Image First";
        imgError="Error"; 
 ...
 function ad_post_validation(){
    ...
    if(y==""){
        ...
        if(isNaN(y)==true){
            rentError="Error";
            document.getElementById("rentError").innerHTML="Rent can only be numbers";
        }else{
            rentError="";
    ...
    if(file1.value==""){
        ...
        if(result==false){
        file1Error="Error";
        document.getElementById("f1Error").innerHTML="Only JPEG, PNG and JPG is allowed";
        }
        else{
            file1Error="";
    ...
    if(file2.value==""){
        ...
        if(result1==false){
        file2Error="Error";
        document.getElementById("f2Error").innerHTML="Only JPEG, PNG and JPG is allowed";
        }
        else{
            file2Error="";
    ...
    if(file3.value==""){
        ...
        if(result2==false){
        file3Error="Error";
        document.getElementById("f3Error").innerHTML="Only JPEG, PNG and JPG is allowed";
        }
        else{
            file3Error="";
    ...
    if(ad_idError!=""|| rentError!="" || addError!="" || descError!="" || file1Error!="" || areaError !="" || file2Error!="" || file3Error!=""){
        return false;
    }
    else if(ad_idError=="" && rentError=="" && addError=="" && descError=="" && file1Error=="" && areaError=="" && file2Error=="" && file3Error==""){
        return true;
    }
 ...
 function edit_ad_validations(){
    ...
    if(rentError!="" || addError!="" || descError!="" || file1Error!="" || areaError !="" || file2Error!="" || file3Error!=""){
        return false;
    }
    else if(rentError=="" && addError=="" && descError=="" && file1Error=="" && areaError=="" && file2Error=="" && file3Error==""){
        return true;
    }
 }
