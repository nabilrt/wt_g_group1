...
$id=$_GET['id'];
require_once '../controller/view_details2.php';
$renter=getuser($id);
?>
<!DOCTYPE html>
<html>
		...
		<div style="display: flex;">
			...
			<div  style="margin-left:10px ;">
	          ...
	          <div style="color: black;">
			      ...
			      <div  >
			        <label> Name: 
			        <span><?php echo $renter["name"]; ?></span>
			        </label>
			        <br><br>
			      </div>
			      <div>
			        <label> Email: 
			        <span><?php echo $renter["email"]; ?></span>
			        </label>
			        <br><br>
			      </div>
			      <div>
			        <label> NID: 
			        <span><?php echo $renter["nid"]; ?></span>
			        </label>
			        <br><br>
			      </div>
			      <div>
			        <label> Gender: 
			        <span><?php echo $renter["gender"]; ?></span>
			        </label>
			        <br><br>
			      </div>
