...
<body class="bd">
    ...
    <div style="display:flex">
        ...
        <div style="display:inline-block; font-family: 'Inria Sans', sans-serif;">
            <div class="form-group" style="padding-left: 50px;">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" onsubmit="return edit_ad_validations()">
                    ...
                    <textarea name="msg" id="desc" class="form-control" rows="5" cols="20" onkeyup="return desc_validate()" onblur="return desc_validate()" value=""><?php echo $ad_des; ?></textarea><br>
