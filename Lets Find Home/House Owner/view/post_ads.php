         ...
         <h3><b>Post Ads</b></h3><br>
            <form method="POST" name="m_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" onsubmit="return ad_post_validation()" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="ad_id" id="ad_id" value="<?php echo "AD-".rand(1000,9999); ?>" onkeyup="return aid_validate()" onblur="return aid_validate()" class="form-control"><span id="idError" style="color:red"></span></div>
                    <div class="col-md-4">
